...
This directory contains the Elixir agent orchestration service that polls an issue tracker, creates per-issue workspaces, and runs Codex in app-server mode.
